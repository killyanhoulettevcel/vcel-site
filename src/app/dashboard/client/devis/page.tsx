...
// avoir, Avoirs, Notes de crédit et remboursements, Aucun avoir émis, BADGE_COLOR, BADGE_BG remplacés
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        <div>
          ...
          <div className="flex items-center gap-3 mt-0.5">
            <p className="text-sm" style={{ color: 'var(--text-muted)' }}>Notes de crédit et remboursements</p>
            {lastUpdate && (
