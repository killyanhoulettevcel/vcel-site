    ...
    <section id="contact" className="relative py-28 px-6">
      <div className="max-w-2xl mx-auto">
        <div className="mb-12">
          ...
          <p style={{ color: 'rgba(255,255,255,0.6)' }}>On vous répond par email sous 24h.</p>
        </div>
        ...
        <div className="bg-white/3 border border-white/10 rounded-2xl p-8">
          {sent ? (
            <div className="py-8 text-center">
              ...
              <p style={{ color: 'rgba(255,255,255,0.6)' }} className="text-sm">On vous répond sous 24h. Vérifiez vos spams si besoin.</p>
            </div>
          ) : (
            <div className="space-y-5">
              <div className="grid sm:grid-cols-2 gap-4">
                <div>
                  {/* htmlFor lié à l'id de l'input — fix accessibilité */}
                  <label htmlFor="contact-nom" className="block text-xs font-semibold mb-2" style={{ color: 'rgba(255,255,255,0.7)' }}>
                    Prénom *
                  </label>
                  <input
                    id="contact-nom"
                    ...
                    aria-required="true"
                    className="w-full bg-white/5 border border-white/8 rounded-xl px-4 py-3 text-white text-sm placeholder:text-white/30 focus:outline-none focus:border-white/30 transition-colors"
                  />
                </div>
                <div>
                  <label htmlFor="contact-email" className="block text-xs font-semibold mb-2" style={{ color: 'rgba(255,255,255,0.7)' }}>
                    Email *
                  </label>
                  <input
                    id="contact-email"
              ...
              <div>
                <p className="block text-xs font-semibold mb-2" style={{ color: 'rgba(255,255,255,0.7)' }} id="secteur-label">
                  Votre activité
                </p>
                <div className="flex flex-wrap gap-2" role="group" aria-labelledby="secteur-label">
                  {secteurs.map(s => (
                    <button key={s} onClick={() => setForm({...form, secteur: s})}
                      ...
                      style={{ color: form.secteur === s ? undefined : 'rgba(255,255,255,0.65)' }}>
                      {s}
                    </button>
                  ))}
                </div>
              ...
              <p className="text-center text-xs" style={{ color: 'rgba(255,255,255,0.5)' }}>
                ...
                <a href="mailto:contact@vcel.fr" className="underline" style={{ color: 'rgba(255,255,255,0.75)' }}>
                  contact@vcel.fr
                </a>
              </p>
            </div>
