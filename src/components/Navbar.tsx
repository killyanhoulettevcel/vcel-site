  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'py-2' : 'py-4'}`}>
      <div className={`mx-auto max-w-6xl px-4 sm:px-6 transition-all duration-300 ${
        scrolled ? 'bg-white/90 backdrop-blur-xl shadow-md-navy border border-[var(--border)] rounded-2xl py-3 px-5' : ''
      }`}>
      ...
      {/* Menu mobile */}
      {open && (
        <div className="md:hidden mx-4 mt-2 bg-white border border-[var(--border)] rounded-2xl p-5 shadow-lg-navy flex flex-col gap-4">
          {links.map(l => (
