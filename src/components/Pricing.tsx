...
export default function Pricing() {
  ...
  // Calcul ROI honnête : combien d'heures faut-il économiser pour rentabiliser ?
  ...
  return (
    <section id="tarifs" className="relative py-28 px-6">
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-16">
          ...
          <p className="text-white/40 text-lg">Un abonnement mensuel. Sans engagement. Résiliable à tout moment.</p>
        </div>

        <div className="grid lg:grid-cols-5 gap-6">

          {/* Carte offre — 3 colonnes */}
          <div className="lg:col-span-3 bg-white/3 border border-white/10 rounded-2xl p-8 relative">
              ...
              <div className="flex items-center p-1 bg-white/5 border border-white/8 rounded-xl gap-1">
                <button onClick={() => setAnnual(false)}
                  className={`px-4 py-1.5 rounded-lg text-sm font-medium transition-all ${
                    !annual ? 'bg-white text-[#080c14]' : 'text-white/40 hover:text-white/70'
                  }`}>Mensuel</button>
            ...
            <div className="mb-8">
              <div className="flex items-end gap-2 mb-1">
                <span className="font-display text-6xl font-extrabold text-white tracking-tight">{prixMensuel}€</span>
            ...
            <div className="flex items-center justify-center gap-5 mt-4 text-white/20 text-xs">
          ...
          {/* Calculateur ROI — 2 colonnes */}
          <div className="lg:col-span-2 flex flex-col gap-4">

            {/* Calculateur */}
            <div className="bg-white/3 border border-white/10 rounded-2xl p-6 flex-1">
              ...
              <div className="mb-6">
                ...
                <input
                  ...
                  onInput={e => setTauxHoraire(Number((e.target as HTMLInputElement).value))}
                  style={{ width: '100%', cursor: 'pointer', accentColor: '#3b82f6', WebkitAppearance: 'auto' }}
                />
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between p-3 bg-green-500/8 rounded-xl border border-green-500/15">
                  ...
                  <span className="text-green-400 font-bold text-sm">
                    x{Math.round(valeur20h / prixMensuel)}
                  </span>
                </div>
              </div>

              <p className="text-white/20 text-xs mt-4 leading-relaxed">
                * Estimation basée sur 20h/mois économisées. Résultats variables selon votre usage.
              </p>
            </div>
            ...
            <div className="bg-white/3 border border-white/10 rounded-2xl p-5">
              ...
              <p className="text-white/35 text-xs leading-relaxed">
                Votre espace client est configuré automatiquement. Vous recevez un email d'activation sous 5 minutes.
              </p>
            </div>
